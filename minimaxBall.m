...
% Reward1 = {[-0.6,-0.9;-0.8,-0.75],-[-0.6,-0.9;-0.8,-0.75]};
% Reward1 = {0.2*[-0.75,-0.8;-0.9,-0.6],0.2*[0.7,0.85;0.9,0.6]};
...
transfer = {[0.9,0.15;0.1,0.95],1-[0.9,0.15;0.1,0.95]};%possibility to go to state1
currentState = 1;
